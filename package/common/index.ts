...
function combinationUrlAndQuery (url: string, query: Record<any, any>, config: Record<string, string[]>) {
 ...
 * @param keys 要过滤的参数
 */
function getHttpData (obj: Record<any, any>, keys: string | string[]) {
	if (!keys) return obj
