...
export const HttpQuery = (keys?: string | string[]): ParameterDecorator => (target: any, propertyKey: string | symbol, parameterIndex: number) => {
...
export const Param = (key: string): ParameterDecorator => (target: any, propertyKey: string | symbol, parameterIndex: number) => {
